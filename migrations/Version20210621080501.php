 ...
 */
final class Version20210621080501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE activites ADD latitude NUMERIC(8, 6) NOT NULL, ADD longitude NUMERIC(9, 6) NOT NULL');
